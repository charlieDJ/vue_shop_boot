...
public class UserController {
     ...
     */
    @PostMapping("/users")
    public R save(@Validated @RequestBody UserAddVO userAddVO){
     ...
     */
    @PutMapping("/users/{id}")
    public R update(@PathVariable("id") Integer id, @RequestBody EditUserInfo userInfo){
        UserVO vo = managerService.updateInfo(id, userInfo.getMobile(), userInfo.getEmail());
