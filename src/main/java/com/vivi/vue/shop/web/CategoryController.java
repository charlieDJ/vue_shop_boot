...
import com.vivi.vue.shop.vo.SaveCateRequest;
...
public class CategoryController {
    ...
    public R save(@Valid @RequestBody SaveCateRequest request){
        CategoryTreeVO category = categoryService.add(request.getCat_pid(), request.getCat_name(), request.getCat_level());
